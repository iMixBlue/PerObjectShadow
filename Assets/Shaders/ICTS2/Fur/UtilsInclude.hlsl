...
half Alpha(float2 uv)
{
    ...
    return _Color.a;
#else
    return SAMPLE_TEXTURE2D(_MainTex,sampler_linear_clamp_MainTex, uv).a * _Color.a;
#endif
}
half4       _SpecColor;
...
{
    half3 albedo = _Color.rgb * SAMPLE_TEXTURE2D (_MainTex,sampler_linear_clamp_MainTex, texcoords.xy).rgb;
#if _DETAIL
    #if (SHADER_TARGET < 30)
